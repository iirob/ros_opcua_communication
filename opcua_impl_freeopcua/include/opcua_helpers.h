...
/**
 * This function converts between opcua_msgs::Address data type into OpcUa::NodeID data type.
...
/**
 * This function converts OpcUa::Variant data type into opcua_msgs::TypeValue data type.
 * @param variant Variant to be converted.
 * @return TypeValue object created from variant.
 */
opcua_msgs::TypeValue convertVariantToTypeValue(const OpcUa::Variant& variant) {
...
/**
 * This function converts opcua_msgs::TypeValue data type into OpcUa::Variant data type.
 * @param typeValue TypeValue to be converted
 * @return Variant object created from typeValue
 */
OpcUa::Variant convertTypeValueToVariant(opcua_msgs::TypeValue& typeValue)
{
